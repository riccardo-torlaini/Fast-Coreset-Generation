...
data,labels = make_blobs(n_samples = 150000, random_state=2137)
costs = []
params = [(3000, 3), (5000, 5), (5000, 10), (10000, 5), (10000, 10), (15000, 3), (15000, 5), (15000, 15)]
for i in params:
    m = i[0]
    k = i[1]
...
for i in range(len(costs)):
    print('For m, k = {}, cost = {}'.format(params[i], costs[i]))