import numpy as np
from bico_master.bico.geometry.squared_euclidean import squared_euclidean_distance
from bico_master.bico.nearest_neighbor.base import NearestNeighbor, NearestNeighborResult
