...
In this paper, we show how to implement sensitivity sampling for $k$-means and $k$-median in near-linear time.
...
We furthermore provide an implementation of our algorithm, \david{say how crazy good it is here}
