...
strategy \andrew{citations?} wherein one first discretizes the input into $b$ blocks and performs sampling and composition along them until a single compression
