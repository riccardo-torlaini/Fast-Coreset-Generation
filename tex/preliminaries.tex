...
\begin{itemize}
    ...
    \item The size of the compressed dataset does not depend on $n$, the size of the original dataset.
    \item Solutions on the compressed dataset are provably good on the original dataset.
\end{itemize}
