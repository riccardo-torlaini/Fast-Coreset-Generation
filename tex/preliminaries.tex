...
and essentially prompts the question \david{which question?}.  Indeed, since the lightweight coreset construction uses the $1$-means solution and sensitivity sampling uses an $O(1)$
