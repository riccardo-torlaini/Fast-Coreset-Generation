...
In terms of other linear-time coreset algorithms, we are only aware of lightweight coresets \cite{BachemL018}, wherein one performs sensitivity sampling with
