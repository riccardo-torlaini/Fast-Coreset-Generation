...
\begin{algorithmic}[1]
   ...
   \State Use a Fast Johnson-Lindenstrauss \andrew{refs?} \chris{I don't know why we'd need a FJL embedding. A normal one does the job as well. I don't think we have to cite anything here.} embedding to compute the embedding $\tilde P$ of $P$ into $\tilde d = O(\log k)$ dimensions
